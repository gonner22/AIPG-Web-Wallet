export const uwu_translation = {
    ...
    dCardOneDesc:
        'Cweate a new PIVX wawwet, offewing da most secuwur backup & securrrity methods.', //Create a new PIVX wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        "Use ur Ledger Hardware wawwet wiv MPW's famiwiar intwerface.", //Use your Ledger Hardware wallet with MPW's familiar interface.
    dCardThreeButton: 'Access my Ledger', //Access my Ledger

    dCardFourTitle: 'Go to', //Go to
    dCardFourSubTitle: 'My Wawwet', //My Wallet
    dCardFourDesc:
        'Impowt a PIVX wawwet using a Pwivate Key, xpriv, or Seed Phrase.', //Import a PIVX wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    popupProposalTitle: 'Pwoposal Title', //Proposal Title
    ...
    BAD_ADDR_LENGTH:
        '<b>Invawed PIVX addwess!</b><br>Bad wength ({addressLength})', //'<b>Invalid PIVX address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Invawed PIVX addwess! Baka!</b><br>Bad pwefix {address} (Should start with {addressPrefix})', //'<b>Invalid PIVX address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hawdware wawwet ready!</b><br>Pwease keep your {hardwareWallet} pwugged in, unwocked, and in da PIVX app ♥', //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the PIVX app",
