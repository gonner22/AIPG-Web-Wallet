export const de_translation = {
    ...
    time_to_sync:
        'Die Zeit in Sekunden, die MPW für den letzten Abgleich gebraucht hat', //The time in seconds it took for MPW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'Die Seed Phrase ist entweder ungültig oder wurde nicht durch MPW erstellt.<br> Willst du trotzdem fortfahren?', //The seed phrase is either invalid or was not generated by MPW.<br>Do you still want to proceed?
    ...
    popupProposalFinalisedSignoff:
        'Viel Glück bei deiner Beteiligung an der DAO, PIVian!', //Good luck on your journey through the DAO, PIVian!
    ...
    INVALID_ADDRESS: '<b>Ungültige PIVX Adresse</b><br> {address}', //<b>Invalid PIVX address!</b><br> {address}
    ...
    NEW_PASSWORD_SUCCESS:
        '<b>Passwort gesetzt! 🔐</b><br>Sehr gut, du bist nun ein geschützter PIVian!', //<b>You\'re Secured! 🔐</b><br>Nice stuff, Armoured PIVian!
    ...
    BAD_ADDR_LENGTH:
        '<b>Ungültige PIVX Adresse!<b><br>Falsche Länge ({addressLength})', //<b>Invalid PIVX address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Ungültige PIVX Adresse!<b><br>Falscher Prefixx {address} (Sollte eigentlich mit {addressPrefix} beginnen)', //<b>Invalid PIVX address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hardware-Geldbörse bereit!</b><br>Bitte lass dein {hardwareWallet} eingesteckt, entsperrt und in der PIVX app aktiviert', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the PIVX app
