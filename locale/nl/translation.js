export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Gemaakt met 💜 door PIVX Labs', //

    // Intro
    loading: 'Bezig met laden', //
    loadingTitle: 'Mijn PIVX-portemonnee is', //
    ...
    dCardOneDesc:
        'Maak een nieuwe PIVX-portemonnee aan, met de meest veilige back-up- en beveiligingsmethoden.', //
    ...
    dCardFourDesc:
        'Importeer een PIVX-portemonnee met een privésleutel, xpriv, of seedzin.', //
    ...
    popupProposalFinalisedNote:
        '<b>Gefeliciteerd met het lanceren van je voorstel!</b><br>Masternode-eigenaren kunnen je Stemhash gebruiken om te stemmen vanuit portefeuilles anders dan MPW, zorg er dus voor dat je deze toevoegt aan je forum post, indien van toepassing!',
    popupProposalFinalisedSignoff:
        'Veel succes op je reis door de DAO, PIViaan!',
    ...
    BAD_ADDR_PREFIX:
        '<b>Ongeldig PIVX-adres!<b><br>Ongeldige prefix {address} (Moet beginnen met {addressPrefix})',
