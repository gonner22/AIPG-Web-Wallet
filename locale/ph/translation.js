export const ph_translation = {
    ...
    loadingTitle: 'My PIVX wallet ay', //My PIVX Wallet is
    ...
    dCardOneDesc:
        "Gumawa ng bagong PIVX wallet, ito'y nag aalok ng pinaka-ligtas na backup at mga paraang pang seguridad", //Create a new PIVX wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        'Gamitin ang iyong Ledger Hardware Wallet na pamilyar sa interface ng MPW', //Use your Ledger Hardware wallet with MPW's familiar interface.
    ...
    dCardFourDesc:
        'I-import ang iyong PIVX wallet gamit ang Private Key, xpriv, o Seed Phrase', //Import a PIVX wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    time_to_sync:
        'Ang bawat segundo sa oras na tumatagal upang muling mag synchronize sa MPW.', //The time in seconds it took for MPW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'Ang seed phrase na ito ay pwedeng hindi wasto o hindi ito generated ng MPW.<br>Gusto mo bang tumuloy?', //The seed phrase is either invalid or was not generated by MPW.<br>Do you still want to proceed?
    ...
    INVALID_ADDRESS:
        '<b>Ang PIVX address na ito ay hindi wasto!</b><br> {address}', //<b>Invalid PIVX address!</b><br> {address}
    ...
    NEW_PASSWORD_SUCCESS:
        '<b>Ikaw ay ligtas! 🔐</b><br>Magandang bagay, Armoured PIVian!', //<b>You\'re Secured! 🔐</b><br>Nice stuff, Armoured PIVian!
    ...
    BAD_ADDR_LENGTH:
        '<b>Hindi wasto ang PIVX address!<b><br>Bad lenght({addressLength})', //<b>Invalid PIVX address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Hindi wasto ang PIVX address!<b><br>Bad prefix{address} (Ito ay dapat nag sisimula sa{addressPrefix})', //<b>Invalid PIVX address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Handa na ang Hardware wallet!</b><br>Pakiusap panatilihin mo na ang {hardwareWallet} ay naka plugged in, naka bukas, at nasa PIVX app ', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the PIVX app
