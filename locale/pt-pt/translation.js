export const pt_pt_translation = {
    ...
    popupSeedPhraseBadNote:
        'A frase inicial é inválida ou não foi gerada pelo MPW.<br>Você ainda quer continuar', //The seed phrase is either invalid or was not generated by MPW.<br>Do you still want to proceed?
    popupCreateProposal: 'Criar Proposta', //Create Proposal
    popupCreateProposalCost: 'Custo', //Cost
    popupProposalTitle: 'Título da Proposta', //Proposal Title
    ...
    NEW_PASSWORD_SUCCESS:
        '<b>Você está protegido! 🔐</b><br>Muito bem, PIVian blindado!', //<b>You\'re Secured! 🔐</b><br>Nice stuff, Armoured PIVian!
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Carteira de hardware pronta!</b><br>Mantenha a sua {hardwareWallet} conectada, desbloqueada e na aplicação PIVX', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the PIVX app
